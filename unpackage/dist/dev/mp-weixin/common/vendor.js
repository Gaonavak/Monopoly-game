  ...
  list: [
    {
      ...
      selectedIconPath: "static/tabBar/home-filled.png"
    },
    {
      text: "社区",
      pagePath: "pages/forum/forum",
      iconPath: "static/forum/chatboxes.png",
      selectedIconPath: "static/forum/chatboxes-filled.png"
    },
    {
      text: "用户中心",
      pagePath: "pages/user/user",
      iconPath: "static/tabBar/person.png",
      selectedIconPath: "static/tabBar/person-filled.png"
    }
  ]
};
const easycom = {
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = b, T = I('{\n    "address": [\n        "127.0.0.1",\n        "198.18.0.1",\n        "10.143.50.26"\n    ],\n    "debugPort": 9002,\n    "initialLaunchType": "remote",\n    "servePort": 7002,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/STU/softwork/uni-app/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), C = I('[{"provider":"aliyun","spaceName":"gaoweinan","spaceId":"mp-fd71ef6a-153a-4a78-ad18-2132a4d02df6","clientSecret":"HFjfeeoffAIflDzTPupIjQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__3165B03";
} catch (e2) {
...
const useGraphicCardCustomStyle = (props) => {
  const ns2 = useNamespace("graphic-card");
...
const useGraphicCard = (props, emits) => {
  ...
  const imageCount = computed(
    () => {
      var _a;
      return isEmptyVariableInDefault((_a = props == null ? void 0 : props.images) == null ? void 0 : _a.length, 0);
    }
  );
...
const useTimeLineCustomStyle = (props) => {
  const ns2 = useNamespace("time-line-item");
...
const useTimeLineDataCustomStyle = (props) => {
  const ns2 = useNamespace("time-line-data");
...
const useLazyLoadCustomStyle = (props) => {
  const ns2 = useNamespace("lazy-load");
